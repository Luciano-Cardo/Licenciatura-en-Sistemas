...
//     Métodos:
//     1. AgregarRegla(ReglaValidacion<T> regla): Este método deberá agregar una regla de validación a la lista de reglas que el 
//        validador aplicará.
//     2. Validar(T objeto, out List<string> errores): Este método deberá validar el objeto proporcionado según todas las reglas de 
//        validación agregadas. Los errores encontrados deben almacenarse en la lista errores. Esta lista debe contener los mensajes 
//        de error correspondientes a las reglas de validación que no se cumplieron.
