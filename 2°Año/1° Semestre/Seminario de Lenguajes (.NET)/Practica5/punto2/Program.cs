using punto2;
// 2) Agregar a la clase Cuenta del ejercicio anterior un método estático GetCuentas() que devuelva un List<Cuenta> con todas las 
//    cuentas creadas. Controlar que la modificación de la lista devuelta, por ejemplo borrando algún elemento, no afecte el listado 
//    que internamente mantiene la clase Cuenta. Sin embargo debe ser posible interactuar efectivamente con los objetos Cuenta de la 
//    lista devuelta. Verificar que el siguiente código produzca la salida por consola que se indica:
